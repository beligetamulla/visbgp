...
class Scenario(ABC):
    ...
    def _get_non_default_asn_cls_dict(
        ...
        logging.debug("Policy Class: %s", self.scenario_config.BasePolicyCls)
        PolicyCls = self.scenario_config.AdoptPolicyCls
        logging.debug("Adopt Policy Class: %s", PolicyCls)
        ...
        # Debug Statements:
        logging.debug("non_default_asn_cls_dict set")
        logging.debug("BasePolicyCls: %s", self.scenario_config.BasePolicyCls)
        logging.debug("AdoptPolicyCls: %s", self.scenario_config.AdoptPolicyCls)
